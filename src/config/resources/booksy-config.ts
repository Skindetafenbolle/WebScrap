...
export function booksyConfig(): ResourceConfig {
    return {
        ...
        selectors: {
            ...
            description: '[class="purify_J9nQDaJUzkiC+6tRVJZ9Ag== purify_Sardy6hfiet162IZ2pYFPA== purify_f9tJlQGTtqZe8Hg0f7oQhg=="] div',
            ...
            serviceDisplayNone: '[class="purify_n+xMHZxOQyWGX+7-kjb8+A=="]',
